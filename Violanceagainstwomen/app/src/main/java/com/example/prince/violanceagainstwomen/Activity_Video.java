...
public class Activity_Video extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity__video);
    ...
    View.OnClickListener captrureListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (recording) {
                ...
                utility.makeToast("Video captured!");
                recording = false;
            } else {
                utility.makeToast(prepareMediaRecorder()+"");
             /*   if (!prepareMediaRecorder()) {
                    utility.makeToast("Fail in prepareMediaRecorder()!\n - Ended -");
                    finish();
                }
